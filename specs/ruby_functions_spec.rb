...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    #add test code here
    volume_of_cube = calculate_volume_of_cube( 9 )
    assert_equal(729, volume_of_cube)
  end
  #
  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_of_sphere = calculate_volume_of_sphere( 2 )
    assert_equal(33 , volume_of_sphere)
  end
  #
  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius = convert_farenheit_to_celsius ( 100 )
    assert_equal(37, fahrenheit_to_celsius)
  end
